...
apigClientFactory.newClient = function (config) {
    ...
    var endpoint = 'https://ymlwdvzrqe.execute-api.us-east-1.amazonaws.com/development';
    ...
    apigClient.tweetPost = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(tweetPostRequest, authType, additionalParams, config.apiKey);
    };
